        ...
        <div class="row" style="margin-top:40px;">
            ...
            @if ($id === 0)
              <div class="col-md-12 col-lg-12 col-sm-12">
                  <div class="white-box">
                    <h2>Tabel Data Program Semester</h2>
                      <p>Berikut adalah daftar Program Semester,  untuk format Program Semester bisa di download <a href="{{asset('/public/data/Format_Program_Semester.doc')}}">disini</a></p>
                      <table class="table table-striped">
                        ...
                        <tbody>
                          @foreach ($data as $promes)
                          <tr>
                            <td>{{$promes->nama}}</td>
                            <td>SDN Pakis V</td>
                            <td>{{$promes->kelas}}</td>
                            <td>{{$promes->tahun}}</td>
                            <td class="row"><a class="col-md-3" href="{{asset('laravel/public/guru/'.$promes->file)}}"><i class="fa fa-download fa-fw" title="View/Download" aria-hidden="true"></i></a><a class="col-md-3" href="{{url('guru/')}}/{{$promes->id}}/promes"><i class="fa fa-edit fa-fw" title="Edit" aria-hidden="true"></i></a></td>
                          </tr>
                          @endforeach
                  ...
                  <div class="col-md-12 col-lg-4 col-sm-12">
                      <div class="white-box">
                      <h3>Update Data Program Semester</h3>
                  <hr />
                  @foreach ($edit as $edit)
                      <form method="post" action="{{url('guru/')}}/{{$edit->id}}/promes"  enctype="multipart/form-data">
                      {{ csrf_field() }}
