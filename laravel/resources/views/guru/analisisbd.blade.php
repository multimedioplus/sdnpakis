        ...
        <div class="row" style="margin-top:40px;">
            ...
            @if ($id === 0)
              <div class="col-md-12 col-lg-12 col-sm-12">
                  <div class="white-box">
                    <h2>Tabel Data Analisis BD</h2>
                      <p>Berikut adalah daftar Analisis BD,  untuk Analisis BD bisa di download <a href="{{asset('/public/data/Analisisbd.xlsx')}}">disini</a></p>
                      <table class="table table-striped">
                        ...
                        <tbody>
                          @foreach ($data as $analisisbd)
                          <tr>
                            <td>{{$analisisbd->updated_at}}</td>
                            <td>{{$analisisbd->oleh}}</td>
                            <td>SDN Pakis V</td>
                            <td>{{$analisisbd->kelas}}</td>
                            <td>{{$analisisbd->tahun}}</td>
                            <td class="row"><a class="col-md-3" href="{{asset('laravel/public/guru/analisisbd/'.$analisisbd->file)}}"><i class="fa fa-download fa-fw" title="View/Download" aria-hidden="true"></i></a><a class="col-md-3" href="{{url('guru/')}}/{{$analisisbd->kelas}}/analisis/bd"><i class="fa fa-edit fa-fw" title="Edit" aria-hidden="true"></i></a></td>
                          </tr>
                          @endforeach
              ...
              <div class="col-md-12 col-lg-8 col-sm-12">
                  <div class="white-box">
                    <h2>Tabel Data Analisis BD</h2>
                      <p>Berikut adalah daftar Analisis BD,  untuk format Analisis BD bisa di download <a href="{{asset('/public/data/Analisisbd.xlsx')}}">disini</a></p>
                      <table class="table table-striped">
                        <thead>
                          <tr>
                            <th>Update Terakhir</th>
